...
// ⚠️ و همان دنباله باید **ایزوله** باشد. بدونِ FSI…PDI ترتیبِ دیداری‌اش در بندِ
// راست‌به‌چپ برعکس می‌شود — رشته درست است و متن هم تطابق می‌دهد، پس بررسیِ بالا
// تنها کافی نیست. در پنل با عکسِ بازرس دیده شد و اینجا هم همان است.
check("دنباله‌ی مبلغ‌ها ایزوله شده تا وارونه دیده نشود",
  capsTo(ADMIN).includes("\u2068۶,۰۰۰,۰۰۰ + ۴,۱۴۰,۰۰۰\u2069"), true);
